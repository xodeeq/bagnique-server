...
from commerce.models import CustomerFeedback, Order, Product
from commerce.serializers import CustomerFeedbackSerializer, OrderSerializer, ProductSerializer
...
class CustomerFeedbackView(CreateAPIView):
